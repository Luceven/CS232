...
$thenext_options = array(
    ...
    'weibo_profile_url' => array(
        'label' => __('Weibo Profile / Page URL', 'the-next'),
        'transport' => 'postMessage',
        'type' => 'url',
        'section' => 'thenext_social',
        'default' => '',
    ),
    'weixin_profile_url' => array(
        'label' => __('WeChat Profile / Page URL', 'the-next'),
        'transport' => 'postMessage',
        'type' => 'url',
        'section' => 'thenext_social',
        'default' => '',
    ),
    'qq_profile_url' => array(
        'label' => __('QQ', 'the-next'),
        'transport' => 'postMessage',
        'type' => 'url',
        'section' => 'thenext_social',
        'default' => '',
